...
CREATE TABLE "GroupAdmins" (
    ...
    CONSTRAINT "GroupAdmins_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "GroupAdmins" ADD CONSTRAINT "GroupAdmins_groupId_fkey" FOREIGN KEY ("groupId") REFERENCES "Group"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "GroupAdmins" ADD CONSTRAINT "GroupAdmins_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "GroupInvites" ADD CONSTRAINT "GroupInvites_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
